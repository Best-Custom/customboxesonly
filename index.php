                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 p-0">
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="main__menu__left__area">
                                    <h1>Custom Packaging That Make Your Brand Stand Out</h1>
                                </div>
                                </div>
                            ...
                            <div class="main__menu_section__buttons p-3">
...
<!-- Customized Solution Code ends here-->
...
<!-- Choose Us Code starts here-->
<section class="choose__us__section">
    <div class="container">
        <div class="row">
            <div class="choose__us__area">
                <h1>Why choose us</h1>
            </div>
        </div>
        <div class="row choose__us__slider__area">
            ...
            <div class="col-9">
                <div class="owl-carousel owl-theme" id="choose__us">
                    <div class="item">
...
<!-- eco_friendly section Code starts here-->
...
<section class="eco__friendly__section">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12 col-sm-12 col-lg-6">
                <div class="eco__friendly__images">
                    <img src="asset/images/eco__friendly__section/eco__friendly__image.png" class="img-fluid" width="100" alt="">
                </div>
            </div>
        </div>
    </div>
...
<!-- eco_friendly section Code ends here-->
