...
<!-- category page section starts here -->
<section class="category__page__section">
    <div class="container">
            <div class="row category__page__heading  p-5">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 category__main__menu__area text-start p-5" style="vertical-align:middle">
                    <h1 class="text-white">Custom Boxes Only Categories</h1>
                    <p class="mt-3 text-white">Unlock the potential of your products with our unrivaled packaging solutions tailored to your industry and specific product needs. </p>
                    <button class="btn__layout1 "><a href="#"> <span> Get A Quote</span></a></button>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 category__main__menu__area text-end mt-3" style=";vertical-align:middle">
                    <img src="asset/images/category__page/category__page__main.png" class="img-fluid" alt="">
                </div>
            </div>
    </div>
</section>
<!-- category page section ends here -->

<!-- button__slider section starts here -->
<section class="button__slider">
    <div class="container">
        <div class="row owl-carousel owl-theme" id="button__slider__area">
            <div class="category__page__btn item">
                <button class="btn__layout1"><a href="#"> <span> Mailer boxes</span></a></button>
            </div>
            <div class="category__page__btn item">
                <button class="btn__layout1 "><a href="#"> <span> Mailer boxes</span></a></button>
            </div>
...
<section class="our__range__section">
    <div class="container">
       <div class="row">
        <div class="col-xs-0 col-sm-0 col-md-3 col-lg-3 toggle__area__section">
            <div class="toggle__area">
                <h4 class="text-start">Important categories</h4>
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 our__range__width">
            <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 p-0 m-0">
...
<!-- contact us compnents code starts here -->

<?php include('components/contact-us.php') ?>

<!-- contact us components code ends here -->
