...
<head>
    ...
    <title>Custom Boxes Only</title>

    <!-- package bootstrap link -->
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <li>
                                                <a class="header__items__area__links nav-link " href="#">
                                                    <img src="asset/images/dropdown__product.png" width="40" height="40" alt="mailer_box">
