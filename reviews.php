    ...
    <div class="container">
        <div class="row">
            <div class="portfolio__section__area text-white">
                <h1 class="text-white text-center">Reviews</h1>
                <p class="text-white text-center">Unloc k the potential of your products with our unrivaled packaging solutions tailored to your industry and specific product needs. </p>
            </div>
        </div>
    </div>
</section>       
...
<section class="our__review">
    <div class="container">
        <div class="row full__review__page">
